        ...
        <div className={styles.container}>
          <div className={styles.center}>
            <Typography variant="subtitle1">
              ...
              artists, <Link href="https://2xaa.fm">2xAA</Link> and{` `}
              <Link href="https://nerddis.co">NERDDISCO</Link>, who come
              together to create a unique and captivating performance. Their
              music, crafted by 2xAA using Gameboy Advance, is paired with
