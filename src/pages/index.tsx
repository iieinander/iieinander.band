        ...
        <div className={styles.container}>
          <div className={styles.center}>
            <Typography variant="subtitle1">
              ...
              artists,{` `}
              <Link href="https://2xaa.fm" target="_blank" rel="noopener">
                2xAA
              </Link>
              {` `}
              and{` `}
              ...
              , who have come together to create a unique and captivating
              performance. Their music, crafted by 2xAA using Game Boy Advance,
              is paired with audio-reactive visuals generated by NERDDISCO in
              real-time, making each performance an unforgettable experience.
            </Typography>
