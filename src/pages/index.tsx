        ...
        <div className={styles.container}>
          <div className={styles.center}>
            <Typography variant="subtitle1">
              ...
              artists, <a href="https://2xaa.fm" target="_blank>2xAA</a> and{` `}
              <a href="https://nerddis.co" target="_blank">NERDDISCO</a>, who have come
              together to create a unique and captivating performance. Their
              music, crafted by 2xAA using Game Boy Advance, is paired with
              audio-reactive visuals generated by NERDDISCO in real-time, making
              each performance an unforgettable experience.
            </Typography>
